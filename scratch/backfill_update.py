        ...
        "predictions": [
            {
                ...
                "occurrence": "first",
                "level": "easy",
                "prompt": "Which two elements are swapped next?",
        ...
        "predictions": [
            {
                ...
                "occurrence": "first",
                "level": "easy",
                "prompt": "Which prefix sum value is written next?",
                "derive": "next_write"
            }
        ]
    },
        ...
        "predictions": [
            {
                ...
                "occurrence": "first",
                "level": "easy",
                "prompt": "Which element's frequency count is updated next?",
                "derive": "next_op"
            }
        ]
    },
        ...
        "predictions": [
            {
                ...
                "occurrence": "first",
                "level": "easy",
                "prompt": "Do the two outer characters match, or is this not a palindrome?",
                "derive": "next_op"
            }
        ]
    },
        ...
        "predictions": [
            {
                ...
                "occurrence": "first",
                "level": "easy",
                "prompt": "Which two characters are swapped next?",
                "derive": "next_swap_pair"
            }
        ]
    },
        ...
        "predictions": [
            {
                ...
                "occurrence": "first",
                "level": "easy",
                "prompt": "Which array index is incremented next?",
                "derive": "next_op"
            }
        ]
    },
        ...
        "predictions": [
            {
                ...
                "occurrence": "first",
                "level": "easy",
                "prompt": "Which pair of elements swaps next?",
                "derive": "next_swap_pair"
            }
        ]
    },
        ...
        "predictions": [
            {
                ...
                "occurrence": "first",
                "level": "medium",
                "prompt": "The first pass is ending. Which two elements swap next?",
                "derive": "next_swap_pair"
            }
        ]
    },
        ...
        "predictions": [
            {
                ...
                "occurrence": "first",
                "level": "medium",
                "prompt": "Which two elements swap next?",
                "derive": "next_swap_pair"
            }
        ]
    },
        ...
        "predictions": [
            {
                ...
                "occurrence": "first",
                "level": "easy",
                "prompt": "Does the current element match the target?",
                "derive": "next_op"
            }
        ]
    },
        ...
        "predictions": [
            {
                ...
                "occurrence": "first",
                "level": "medium",
                "prompt": "Does the search go left or right?",
