...
| `POST /api/activities/` | Create activity; initializes SM-2 state and schedules the **first review tomorrow** (or **due now** for the user's first-ever activity = onboarding demo). Returns `review_due_now`. |
