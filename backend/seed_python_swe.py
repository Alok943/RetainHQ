...
NODES = [
    ...
    (P1, "Collections", "Strings & string methods", "easy"),
    (P1, "Collections", "Slicing lists & strings", "medium"),
    ...
    (P1, "Collections", "Loop idioms: range, enumerate, zip", "medium"),
    (P1, "Collections", "Sorting with sorted and key=", "medium"),
