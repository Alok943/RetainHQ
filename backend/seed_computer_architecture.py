...
ROADMAP_ID = uuid.UUID("b0b0b0b0-b0b0-b0b0-b0b0-b0b0b0b0b0b0")
SLUG = "computer-architecture"
TITLE = "Computer Architecture"
DESCRIPTION = "How computers actually work: CPU design, memory hierarchy, instruction sets, and hardware-software interface."
