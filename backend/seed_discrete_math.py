...
ROADMAP_ID = uuid.UUID("a0a0a0a0-a0a0-a0a0-a0a0-a0a0a0a0a0a0")
SLUG = "discrete-math"
TITLE = "Discrete Mathematics"
DESCRIPTION = "Logic, set theory, combinatorics, and graph theory - the mathematical foundation of computer science."
