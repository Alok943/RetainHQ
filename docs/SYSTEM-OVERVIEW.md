...
| Piece | Contents |
|---|---|
| `main.py` | App, env-driven CORS allow-list, `/health`, `/me`, mounts **12 routers**; `logging.basicConfig(INFO)` + gated `sentry_sdk.init` |
